...
- **Right side:** four buttons — the **bottom (pink ▲) button jumps**, and the **top (🪨) button turns you into a rock** for 3 seconds. The left and right buttons don't do anything yet.
...
Desktop fallback: arrow keys / WASD to move, Space to jump, R to turn to rock.
