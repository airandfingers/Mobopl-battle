...
- **Sound:** a cheerful tune loops in the background and switches to a faster, brighter one while you're flying as the fox. Dash swooshes, jumps boing, the rock lands with a hwump, bows twang when an arrow is loosed, and poodles yap when you get close. Everything is synthesized in the browser — no audio files. The 🔊 button in the top-right corner mutes it.
